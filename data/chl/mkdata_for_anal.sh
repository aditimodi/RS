...
$CDO -selyear,1998/2023 -sellonlatbox,30,50,10,30 $dPath/CCI_ALL-v6.0-8DAY.nc4 $dPath/CCI_ALL-v6.0-8DAY_1998-2023.nc4
...
$CDO -remapbil,gridspec.txt $dPath/CCI_ALL-v6.0-8DAY_1998-2023.nc4 $dPath/chl_v6.0_8day_1998-2023_0.25deg_remapbil.nc4